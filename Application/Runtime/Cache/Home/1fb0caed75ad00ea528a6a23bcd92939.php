...
<div class="header">
    <div class="header-inner row">
        ...
        <div class="btn-group col-xs-3">
            ...
            <?php if(!session(C('USER_AUTH_KEY'))): ?>unlogin<?php endif; ?>" data-toggle="dropdown">
                <span class="glyphicon glyphicon-user"></span>
                <span class="caret"></span>
            </button>
            <ul class="dropdown-menu" role="menu">
                <?php if(session(C('USER_AUTH_KEY'))): ?><li><a href="<?php echo U('Home/User/index');?>">个人中心</a></li>
                    <li class="divider"></li>
                    <li><a href="<?php echo U('Home/User/loginout');?>">退出</a></li>

                    <?php else: ?>

                    <li><a href="<?php echo U('Home/User/login');?>">登录</a></li><?php endif; ?>
    ...
    <div>
        <div class="page-header">
            ...
            <h1>
                ...
                或者直接
                <a href="<?php echo(U('Home/Index/index')); ?>"> 返回首页</a></small></h1>
